...
This file lives at `.github/docs/mcp-README.md`. GitHub Pages does not serve `.github/`,
so it is not publicly fetchable. A short public pointer remains at `mcp/README.md` because
