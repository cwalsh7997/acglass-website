...
ALLOWED_NOINDEX_LINK_TARGETS = {
    ...
    "/assisted-living-glazing-naples/",
    "/assisted-living-glazing-orlando/",
    "/assisted-living-glazing-west-palm-beach/",
    "/automotive-showroom-glazing-fort-lauderdale/",
    "/automotive-showroom-glazing-orlando/",
    "/automotive-showroom-glazing-tampa/",
    "/automotive-showroom-glazing-west-palm-beach/",
    "/bar-brewery-glazing-miami/",
    "/bar-brewery-glazing-orlando/",
    "/bar-brewery-glazing-tampa/",
    "/country-club-glazing-boca-raton/",
    "/country-club-glazing-naples/",
    "/country-club-glazing-palm-beach/",
    "/eswindows-impact-window-installer-boca-raton/",
    "/eswindows-impact-window-installer-palm-beach/",
    "/euro-wall-folding-door-installer-miami/",
    "/government-municipal-glazing-miami/",
    "/government-municipal-glazing-tallahassee/",
    "/gym-fitness-glazing-miami/",
    "/gym-fitness-glazing-naples/",
    "/gym-fitness-glazing-orlando/",
    "/gym-fitness-glazing-tampa/",
    "/healthcare-glazing-jacksonville/",
    "/healthcare-glazing-miami/",
    "/healthcare-glazing-orlando/",
    "/healthcare-glazing-tampa/",
    "/marina-glazing-miami-beach/",
    "/marina-glazing-naples/",
    "/multifamily-glazing-fort-lauderdale/",
    "/multifamily-glazing-miami/",
    "/multifamily-glazing-naples/",
    "/multifamily-glazing-orlando/",
    "/multifamily-glazing-tampa/",
    "/multifamily-glazing-west-palm-beach/",
    "/religious-glazing-miami/",
    "/religious-glazing-orlando/",
    "/religious-glazing-tampa/",
    "/showroom-glazing-miami/",
    "/showroom-glazing-naples/",
    "/university-college-glazing-gainesville/",
    ...
    # 2026-09-24: root commercial-glazing-*.html aliases that canonicalized
    # to noindex storefront templates or noindex city roots. Files stay.
    # They are noindex,follow and canonical to the Florida hub. Indexable
    # pages keep their existing hrefs.
