...
All sends from connor@acglass.com. Confirmed in Outlook Sent Items this run. A send is not a listing change. Do not invent extra sends. Inbox this run: no replies to these nine messages.
...
- **Manta.** Correction/removal form submitted 2026-09-02. They will email connor@acglass.com within 5 business days. Listing still spam: Virginia Gardens / (276) 466-2743 / Steve Thorogood. Inbox this run: no Manta reply. [NEED: Manta email and a live listing recapture.]
...
Do not say posting is active. West Palm Beach posting was turned off after policy rejections. Naples case 2-8095000041141 still open unless independently verified (this run cannot). Tampa still suspended.
...
- AGC FEC directory check to Michelle@agcfla.com: **not sent** (Auto-review blocked)
- BOMA FTLPB associate directory to melanie@bomaftlpb.org: **not sent** (Auto-review blocked)
...
- Naples Google Business Profile: case 2-8095000041141 still open unless independently verified. This run cannot verify. [NEED: case status and what the listing currently shows]
