...
Last updated: 2026-09-03 (wave-3 audit + hub inbound; ESWindows product page still skipped)
...
- Leftover first-party `Euro-Wall authorized` on `/services.html` and `Euro-Wall dealer (authorized)` in `/llms.txt`. Claims PR, not this one.
